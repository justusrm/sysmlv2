...
import de.monticore.lang.sysmlbasis._ast.ASTConstraintUsageBuilder;
import de.monticore.lang.sysmlbasis._symboltable.PartDefSymbol;
import de.monticore.lang.sysmlbasis._ast.ASTRequirementUsageBuilder;
...
public class ASTPartDefBuilder extends ASTPartDefBuilderTOP {
  ...
  /**
   * Transformiert die vorhandenen PartUsages zu ihrem, sofern vorhanden, passenden HLR/LLR-Equivalent. "Passende" Part Usages werden basierend auf {@link PartDefSymbol#getRefinementScore(PartDefSymbol)} ausgewählt.
   * @param targetType
   */
